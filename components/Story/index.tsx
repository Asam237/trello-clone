            ...
            >
              ...
              <div key={item.index} className="mt-4 shadow-lg">
                <div className="flex flex-col lg:flex-row">
                  <div className="w-full lg:w-2/3 bg-white rounded-tl-lg rounded-tr-lg lg:rounded-tr-none lg:rounded-bl-lg">
                    <div className="p-10 flex flex-col h-full justify-between">
                      <p className="text-base lg:text-xl text-gray-700 font-normal mt-6">
                        {item.content}
                      </p>
                      <div className="my-20 h-[1px] w-32 bg-[#091E42]"></div>
                      <div>
                        <p className="text-sm lg:text-base text-[#091E42]">
                          {item.name}
                        </p>
                        <p className="text-sm lg:text-base text-[#091E42]">
                          {item.position}
                      ...
                      <div className="flex items-center justify-between mt-6">
                        ...
                        <p className="text-sm lg:text-base text-blue-600 underline underline-offset-2">
                          Read the story
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full lg:w-1/3 bg-gradient-to-r from-indigo-500 to-rose-300 lg:rounded-tr-lg rounded-bl-lg lg:rounded-bl-none rounded-br-lg">
                    <div className="mt-6 p-10 flex flex-col justify-between h-full">
                      <p className="text-base lg:text-3xl text-white">
                        {item.header}
                      </p>
                      <p className="text-sm lg:text-base text-white mt-10 underline underline-offset-2">
