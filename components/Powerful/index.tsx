...
const PowerfulComponent = () => {
  return (
    <div className="bg-white">
      <div className="container mx-auto xl:w-10/12 mt-48 mb-12">
        ...
        <p className="text-base xl:text-xl text-gray-700 font-normal mt-6 xl:w-7/12">
          ...
          {actions.map((item) => {
            return (
              ...
              >
                ...
                <h4 className="text-xl xl:text-2xl mt-4 font-bold">
                  {item.title}
                </h4>
                <p className="text-sm xl:text-base text-gray-700 font-normal mt-6 h-24">
                  {item.description}
                </p>
                <ButtonComponent variant="text-sm xl:text-base font-normal px-4 py-2 border border-blue-600 rounded-md mt-6">
                  {item.button}
                </ButtonComponent>
              </div>
            );
